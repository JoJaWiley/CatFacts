    ...
    <nav>
     ...
     <form id="redirectForm" action="#">
        ...
        <%  
            ...
            {
            %>
            <h3 class="text-stuff blue-font">There are no threads on this board yet.</h3>
            <%
                if (!Objects.isNull(myuser))
                {
        %>
        <br>
        <br>
            <a class="add-post text-stuff" href="threadstart.jsp?threadCatID=<%=threadCatID%>">Start a new thread</a>
            <%
                } //end inner if
            } else {
