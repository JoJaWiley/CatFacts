...
<script>
  ...
  window.onclick = function(event) {
    ...
    <div class="card-container card-separator">
        <h1> Contact Us</h1> 
    </div>
    ...
    <div class="card-container">
        <a class="card-link" href="submission.jsp">
            <h2>Submit a Help Ticket</h2>
        </a>
            <p>
                Provide a detailed explanation on what you are reporting,<br>
                and if possible provide images to help the investigation.<br>
                Thank you!
            </p>
    </div>
